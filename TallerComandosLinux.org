...
#+email: anthony.erazo01@epn.edu.ec, dylan.zuniga@epn.edu.ec, joset.muela@epn.edu.ec
#+language: Español
#+select_tags: export
...
8. Mueva recursivamente las carpetas ~/Train y ~/Test dentro de ~/FashionData
   ...
   #+RESULTS:
   : total 8
   : drwxr-xr-x 2 anthony-el anthony-el 4096 Jun 29 19:40 Test
   : drwxr-xr-x 2 anthony-el anthony-el 4096 Jun 29 19:39 Train

9. Verifique la estructura de la carpeta /FashionData usando el comando ~tree
   #+begin_src shell :exports both :results output
     tree ~/FashionData
   #+end_src
...
API_KEY = '93cf2482c3b49264eee97fcc298c938e'
LAT = -0.2299
LON = -78.5249
...
if __name__ == "__main__":
    ...
    # Esto hará que se imprima y se muestre TODO en el #+RESULTS:
    print("Estado: Datos de clima guardados exitosamente.")
    print(f"Fecha y Hora: {datos[0]}")
    print(f"Temperatura:  {datos[1]} °C")
    print(f"Humedad:      {datos[2]} %")
    print(f"Descripción:  {datos[3]}")
#+end_src
   #+RESULTS:
   : Estado: Datos de clima guardados exitosamente.
   : Fecha y Hora: 2026-06-29 23:29:48
   : Temperatura:  9.74 °C
   : Humedad:      75 %
...
echo "¡Archivo get-weather.sh generado con éxito!"
ls -l get-weather.sh
#+end_src
   #+RESULTS:
   | ¡Archivo   | get-weather.sh | generado | con     | éxito! |     |    |       |                |
   | -rwxr-xr-x |              1 | dylanux  | dylanux |     53 | Jun | 29 | 23:30 | get-weather.sh |
